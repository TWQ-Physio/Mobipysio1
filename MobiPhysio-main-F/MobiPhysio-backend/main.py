...
Movement Score: <ai_estimated_quality_score>/100

What You Did Well:
- <one grounded strength>

What to Improve:
- <one grounded improvement or safe general coaching point>
...
Safety note: This feedback is for exercise-support purposes only and is not a medical diagnosis or a replacement for guidance from a qualified physiotherapist.
""".strip()
